...
import { getDefaultDashboardRoute } from "./authUtlils";
import { TAuthUser } from "./authUtlils";


export const getCommonNavItems = (role : TAuthUser) : NavSection[] => {
...
export const getNavItemsByRole = (role : TAuthUser) : NavSection[] => {
