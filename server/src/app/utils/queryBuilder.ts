...
// import { PrismaFindManyArgs, PrismaCountArgs, PrismaModelDelegate, IQueryParams, IQueryConfig,PrismaStringFilter,
//     PrismaWhereConditions, IQueryResult, PrismaNumberFilter
//  } from "../interfaces/queryBuilder.interface";

import { IQueryConfig, IQueryParams, IQueryResult, PrismaCountArgs, PrismaFindManyArgs, PrismaModelDelegate, PrismaNumberFilter, PrismaStringFilter, PrismaWhereConditions } from "../interfaces";
